...
@description('A custom object defining the private DNS properties of private DNS. { private-dns-zone-name: { private-dns-zone-url: string, locaiton: string } }')
...
module privateDnsModule 'privateDns.bicep' = {
  name: take(replace(deploymentNameStructure, '{rtype}', 'privateDns'), 64)
  params: {
    deploymentNameStructure: deploymentNameStructure
